    ...
    return (
        <div name="skills" className="w-full h-screen text-blue-700">
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
                <p className="text-4xl font-bold inline border-b-4 border-red-600 text-[#8892b0] py-4">Skills</p>
                <p className="py-4 font-bold text-[#8892b0]">Tech that I'm Familiar With:</p>
